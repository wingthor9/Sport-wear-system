/*
  ...
  - Added the required column `updatedAt` to the `ImportDetail` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `updatedAt` to the `PurchaseDetail` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Import" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;

-- AlterTable
ALTER TABLE "ImportDetail" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
...
-- AlterTable
ALTER TABLE "PurchaseDetail" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
...
-- CreateIndex
CREATE INDEX "PurchaseDetail_purchase_id_idx" ON "PurchaseDetail"("purchase_id");

-- CreateIndex
CREATE INDEX "PurchaseDetail_product_id_idx" ON "PurchaseDetail"("product_id");

-- CreateIndex
CREATE INDEX "PurchaseOrder_supplier_id_idx" ON "PurchaseOrder"("supplier_id");

-- CreateIndex
CREATE INDEX "PurchaseOrder_employee_id_idx" ON "PurchaseOrder"("employee_id");
